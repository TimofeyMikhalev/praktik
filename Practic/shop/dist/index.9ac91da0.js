            ...
            button.addEventListener("click", (event)=>{
                ...
                <div class="check__info">
                    ...
                    <div class="info__stars">
                        <div class="stars">
                            <span class="star active" data-value="1">\u{2605}</span>
                            <span class="star active" data-value="2">\u{2605}</span>
                            <span class="star active" data-value="3">\u{2605}</span>
                            <span class="star" data-value="4">\u{2605}</span>
                            <span class="star" data-value="5">\u{2605}</span>
                          </div>
                          <div class="info">
